...
app = FastAPI(title='Backstract Generated APIs - coll-58d817b6f2c34e729a8fe7c42131986f', debug=False,
              docs_url='/vigorous-shockley-6e7a7ce8eaa311efab560242ac12000587/docs',
              openapi_url='/vigorous-shockley-6e7a7ce8eaa311efab560242ac12000587/openapi.json')
...
app.include_router(
    router,
    prefix='/vigorous-shockley-6e7a7ce8eaa311efab560242ac12000587/api',
    tags=['APIs v1']
)
